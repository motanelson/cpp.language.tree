...
def parse_cpptree_tree(file_path):
...
def main():
    file_name = input("Enter the name of the .cpp c++ language file to load: ")

    try:
        tree = parse_cpptree_tree(file_name)
        print("\nParsed c++ language Tree:")
        print(tree)
